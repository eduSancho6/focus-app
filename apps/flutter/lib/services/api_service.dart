...
class ApiService {
  ...
  Future<Map<String, dynamic>> createArea(String name) {
    return post('/areas', {'name': name});
  }
  ...
  Future<Map<String, dynamic>> createHabit(String name) {
    return post('/habits', {'name': name});
  }
